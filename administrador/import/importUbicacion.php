   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (($handle = fopen($archivo_tmp, "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
            ...
            $sql = "INSERT INTO ubicacion (ubica_id, nombre_ubicacion, fk_desti_id, fk_pais, fk_departamento, fk_ciudad, estado) VALUES ('$data[0]', '$data[1]', '$data[2]', '$data[3]', '$data[4]', '$data[5]', '$data[6]')";

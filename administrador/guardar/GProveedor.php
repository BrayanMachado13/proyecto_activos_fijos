...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM provedor WHERE idprovedor = $id";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO provedor (idprovedor, nombre_provedor, estado) VALUES ($id, '$nombre', '$estado')";
...
if (!empty($error_msg)) {
    header("Location: ../proveedor.php?error_msg=$error_msg");
} else {
    header("Location: ../proveedor.php?success_msg=$success_msg");
}
?>

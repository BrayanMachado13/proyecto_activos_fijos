...
<body style="background-image: url(../complemento/imagen/fondoweb.jpg);">
    ...
    <div class="container">
        ...
        <button type="button" onclick="generarPDF()" class="btn third">Generar Reporte</button>
            ...
            <div class="col-md-8">
                ...
                <table class="bigtables table  table-striped table-hover ">
                    <tbody>
                        ...
                        <?php 
                            $sql="SELECT zn.idzona, zn.nombre_zona, pa.nombre_pais AS nombre_pais,

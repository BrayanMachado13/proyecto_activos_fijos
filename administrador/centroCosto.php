                        ...
                        <li class="nav-item">
                            <i>
                                <a class="nav-item nav-link bi bi-plus-square-dotted"
                                    href="pantallas/crear_centrocosto.php"> Nueva Centro de costo</a>
                            </i>
                        </li>
                    </ul>
                    <form class="d-flex">
            ...
            <div class="col-md-8">
                ...
                <table class="bigtables table  table-striped table-hover">
                    <tbody>
                        ...
                        <?php 
                        include_once 'busquedas/buscarCentrocosto.php';
                        ?>
                        ...
                        <tr>
                            <td>
                                <?php echo $mostrar['idcentrocosto']?>
                            </td>
                            <td>
                                <?php echo $mostrar['nombre_centrocosto']?>
                            </td>
                            <td>
                                <?php echo $mostrar['fk_idzona']?>
                            </td>
                            <td>
                                <?php echo $mostrar['nombre_pais']?>
                            </td>
                            <td>
                                <?php echo $mostrar['nombre_departamento']?>
                            </td>
                            <td>
                                <?php echo $mostrar['nombre_ciudad']?>
                            </td>
                            <td>
                                <i class="separar">
                                    <form class="button_to" method="post" action="botones/inhabilitarCentroCosto.php"
                                        onsubmit="return confirm('¿Estás seguro de que quieres eliminar este centro de costo?');">
                                        <input type="hidden" name="id" value="<?php echo $mostrar['idcentrocosto']?>"
                                            autocomplete="off">

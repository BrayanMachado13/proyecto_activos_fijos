<?php
 ...
 $sql_departamento = "SELECT id, nombre_departamento FROM departamento";
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h3 class="card-title " style="text-align: center;"> REGISTRAR NUEVO CIUDADES</h3>
                                    <p class="text-center">A continuación digita los datos de la ciudad</p>
                                ...
                                ?>
                                    ...
                                    ?>
                                            ...
                                            <a class="bi bi-skip-backward-btn-fill text-dark btn"
                                                title="Retornar a los tipos de activo" href="../ciudad.php"></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col md-8">
                    <div class="bg-card-personal card  text-white">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h5 class="card-title ">REGISTRO MASIVO DE CIUDADES</h5>
                                    <p class="text-center">Escoja un archivo en formato .CSV para la creación masiva de
                                        ciudades</p>
                                </div>
                            </div>
                            <div class="text-center text-dark">
                                <form enctype="multipart/form-data" action="../import/importCiudad.php"

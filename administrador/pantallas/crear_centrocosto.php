<?php
     ...
     $sql_centrocosto = "SELECT idzona, nombre_zona FROM zona";
...
<body style="background-image: url(../../complemento/imagen/fondoweb.jpg);">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h3 class="card-title " style="text-align: center;"> REGISTRAR NUEVO CENTRO DE COSTO
                                    </h3>
                                    <p class="text-center">A continuación digita los datos del Centro de costo</p>
                                    <div class="centrarcard">
                                        <form action="../guardar/GCentrocosto.php" method="post">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nombreccosto"
                                                    name="nombreccosto" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="selectcentrocosto" class="form-label">seleccione la
                                                    zona</label>
                                                <select class="form-select" aria-label="Default select example"
                                                    name="selectzona" id="selectzona" required>
                                            ...
                                            <a class="bi bi-skip-backward-btn-fill text-dark btn"
                                                title="retornar a los centros de costo" href="../centroCosto.php"></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <center>
        <div class=" mt-3 container tam-card-personal">
                ...
                <div class="col md-8">
                    <div class="bg-card-personal card  text-white">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h5 class="card-title ">REGISTRO MASIVO DE CENTROS DE COSTOS</h5>
                                    <p class="text-center">Escoja un archivo en formato .CSV para la creación masiva de
                                        Centro de costo</p>
                                </div>
                            </div>
                            <div class="text-center text-dark">
                                <form enctype="multipart/form-data" action="../import/importCentroCosto.php"
            ...
            <script src="js/importCCosto.js"></script>
        </div>
    </center>
    <br><br><br>
</body>

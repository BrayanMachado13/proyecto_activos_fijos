                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h3 class="card-title " style="text-align: center;"> REGISTRAR NUEVO DEPARTAMENTO
                                    </h3>
                                    <p class="text-center">A continuación digita los datos del del departamento</p>
                                    <div class="centrarcard">
                                        <form action="../guardar/GDepartamento.php" method="post">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    name="selectpais" id="selectpais" required>
                                            ...
                                            <a class="bi bi-skip-backward-btn-fill text-dark btn"
                                                title="Retornar a los departamentos" href="../departamentos.php"></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col md-8">
                    <div class="bg-card-personal card  text-white">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h5 class="card-title ">REGISTRO MASIVO DE DEPARTAMENTOS</h5>
                                    <p class="text-center">Escoja un archivo en formato .CSV para la creación masiva de
                                        departamentos</p>
                                </div>
                            </div>
                            <div class="text-center text-dark">
                                <form enctype="multipart/form-data" action="../import/importDepartamentos.php"

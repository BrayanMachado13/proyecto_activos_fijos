                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h3 class="card-title " style="text-align: center;"> REGISTRAR NUEVO PAIS</h3>
                                    <p class="text-center">A continuación digita los datos del Pais</p>
                                    <div class="centrarcard">
                                        <form action="../guardar/GPais.php" method="post">
                                            <div class="mb-3">
                ...
                <div class="col md-8">
                    <div class="bg-card-personal card  text-white">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h5 class="card-title ">REGISTRO MASIVO DE PAISES</h5>
                                    <p class="text-center">Escoja un archivo en formato .CSV para la creación masiva de
                                        paises</p>
                                </div>
                            </div>
                            <div class="text-center text-dark">
                                <form enctype="multipart/form-data" action="../import/importPais.php"

...
<body style="background-image: url(../../complemento/imagen/fondoweb.jpg);">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h3 class="card-title " style="text-align: center;"> REGISTRAR NUEVO PUNTO DE VENTA
                                    </h3>
                                    <p class="text-center">A continuación digita los datos del Punto de venta</p>
                                    <div class="centrarcard">
                                        <form action="../guardar/GDestinos.php" method="post">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="selectcentrocosto" class="form-label">seleccione el centro
                                                    costo</label>
                                                <select class="form-select" aria-label="Default select example"
                                                    name="selectcentrocosto" id="selectcentrocosto">
                                                    <?php
    ...
    <center>
        <div class=" mt-3 container tam-card-personal">
                ...
                <div class="col md-8">
                    <div class="bg-card-personal card  text-white">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col text-dark">
                                    <h5 class="card-title ">REGISTRO MASIVO DE DESTINOS</h5>
                                    <p class="text-center">Escoja un archivo en formato .CSV para la creación masiva de
                                        destinos</p>
                                </div>
                            </div>
                            <div class="text-center text-dark">
                                <form enctype="multipart/form-data" action="../php/importDestinos.php"
            ...
            <script src="js/importDestinos.js"></script>
        </div>
    </center>

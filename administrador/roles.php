            ...
            <div class="container-fluid">
                <div class="navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <i>
                                <a class="nav-item nav-link bi bi-plus-square-dotted" href="pantallas/crear_perfil.php"> Nuevo rol</a>
                            </i>
                        </li>
                    </ul>
                    <form class="d-flex">
                        <input placeholder="Buscar el rol acá" onchange="this.form.requestSubmit()" type="text"
                ...
                <table class="bigtables table  table-striped table-hover ">
                    <tbody>
                        ...
                        <?php 
                            ...
                            ?>
                        <tr>
                            <td><?php echo $mostrar['idroles']?></td>
                            <td><?php echo $mostrar['nom_rol']?></td>
                            <td>
                                <i class="separar">

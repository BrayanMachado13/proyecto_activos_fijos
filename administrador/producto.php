...
<head>
    ...
    <script>
        function generarPDF() {
            ...
            window.open('pdf/PDFProducto.php', '_blank');
        }
    </script>
</head>
            ...
            <div class="container-fluid">
                <div class="navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <i>
                                <a class="nav-item nav-link bi bi-plus-square-dotted" href="pantallas/crear_producto.php"> Nuevo producto</a>
                            </i>
                        </li>
                    </ul>
                    <form class="d-flex">
                        ...
                        <input placeholder="Busca el producto acá" onchange="this.form.requestSubmit()" type="text"

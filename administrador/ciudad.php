            ...
            <div class="container-fluid">
                <div class="navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <i>
                                <a class="nav-item nav-link bi bi-plus-square-dotted" href="pantallas/crear_ciudad.php">
                                    Nuevo Ciudad</a>
                            </i>
                        </li>
                    </ul>
            ...
            <div class="col-md-8">
                ...
                <table class="bigtables table  table-striped table-hover ">
                    <tbody>
                        ...
                        <?php 
                        include_once 'busquedas/buscarCiudad.php';
                        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <i class="separar">
                                    <form class="button_to" method="post" action="botones/inhabilitarCiudad.php"
                                        onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta ciudad?');">
